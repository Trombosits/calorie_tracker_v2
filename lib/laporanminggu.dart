...
class _laporanMinggu extends StatelessWidget {
  const _laporanMinggu({required this.isShowingMainData});
            ...
            children: <Widget>[
              ...
              Expanded(
                child: Padding(
                  ...
                  child: _laporanMinggu(isShowingMainData: isShowingMainData),
                ),
              ),
              const SizedBox(
                height: 10,
